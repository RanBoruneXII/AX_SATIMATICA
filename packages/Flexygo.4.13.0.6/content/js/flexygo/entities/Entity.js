        ...
        */
        class Entity {
           ...
           */
             ...
             * @return {boolean} - Success or fail.
            */
            insert(jsBeforeExecuted = false) {
                var ctx = this;
                var ret = false;
                var params = { ObjectName: null, Properties: null, JSBeforeExecuted: null };
                params.ObjectName = ctx.objectName;
                params.Properties = flexygo.utils.dataToArray(ctx.data);
                params.JSBeforeExecuted = jsBeforeExecuted;
                flexygo.ajax.syncPost('~/api/Entity', 'Insert', params, function (response) {
                    ...
                    ctx.jsBeforeExecuted = response.JSBeforeExecuted;
             ...
             * @return {boolean} - Success or fail.
            */
            update(jsBeforeExecuted = false) {
                var ctx = this;
                var ret = false;
                var params = { ObjectName: null, ObjectWhere: null, Properties: null, JSBeforeExecuted: null };
                params.ObjectName = ctx.objectName;
                params.ObjectWhere = ctx.objectWhere;
                params.Properties = flexygo.utils.dataToArray(ctx.data);
                params.JSBeforeExecuted = jsBeforeExecuted;
