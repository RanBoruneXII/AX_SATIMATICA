declare namespace flexygo.nav {
   ...
   */
    function execProcessAsync(processname: string, objectname: string, objectwhere: string, defaults: any, processparams: any, targetid: string, excludeHist: boolean, triggerElement: JQuery, callBack?: any, showProgress?: boolean, jsBeforeExecuted?: boolean, isBefore?: boolean, originalProcess?: flexygo.Process): Promise<any>;
